...
$mailer -> AddAddress('web@cientz.com.br', 'Pedido de Remoção de Cliente - Amigo Cidral'); //Destinatario.
$mailer -> Subject = 'Pedido para remover cliente - Amigo Cidral';
$mailer -> Body = "
<h2>Pedido de Remoção de Cliente - Amigo Cidral</h2>
<br/>
<b>$objUsuario->nome</b> fez o pedido para remover o registro do cliente <b>$objAmigo->nome</b> do programa Amigo Cidral.
<br/><br/>
