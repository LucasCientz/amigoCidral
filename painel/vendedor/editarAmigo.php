...
<script>
    ...
    function confirmarEdit() {
        if (confirm("Um pedido para atualizar o amigo será enviado ao email do gerente principal, confirmar?")) {
            return true;
        } else {
            return false;
        }
        ...
        <div class="PagePainel">
            ...
            <div class="ContentPainel">
                <div class="content-inner">
                    <h4>Editar Amigo</h4>
                    <div class="pull-left">
                        <form class="form-horizontal" role="form" method="post" action="../../includes/functions/edicoes/amigoPvendedor.php?idAmigo=<?php echo $idAmigo . '&' . 'idUsuario=' . $idUsuario ?>">
                    ...
                    <div class="pull-right">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-success" onclick='return confirmarEdit();'>
