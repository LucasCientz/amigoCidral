...
<script>
    ...
    function confirmarDelete() {
        if (confirm("Um pedido de remover o amigo será enviado ao email do gerente principal, confirmar?")) {
            return true;
        } else {
            return false;
        }
            ...
            <div class="ContentPainel">
                <div class="content-inner">
                    ...
                    <div class="pull-right">
                        <a type="button" class="btn btn-success" href="cadastrarAmigo.php"><span class="glyphicon glyphicon-plus"></span>&nbsp;&nbsp;Novo Amigo</a>
                    </div>
                    <br/>
                    <br/>
                    <br/>
                    ...
                    if ($totalPags > 0) {
                        ...
                        if (isset($_GET['busca']) == "") {
							...
							<a title='Remover' href='../../includes/functions/deletarAmigo-Vendedor.php?idAmigo=$obj->idAmigo&idUsuario=$idUsuario' onclick='return confirmarDelete();'><i class='glyphicon glyphicon-trash'></i></a>
							</td>";
                                echo "</tr>";
                            }
                        } else {
							...
							<a title='Remover' href='../../includes/deleteDados.php?idAmigo=$objGet->idAmigo' onclick='return confirmarDelete();'><i class='glyphicon glyphicon-trash'></i></a>
							</td>";
                                echo "</tr>";
                            }
                        }
