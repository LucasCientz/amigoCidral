                ...
                <div class="content-inner">
                    <div class="painelInfos">
                        ...
                        <div id="btns_historico">
                            <br/>
                            <a class="btn btn-primary" type="button" rel="shadowbox" href="historicoVendas.php?idAmigo=<?php echo $obj->idAmigo ?>"><div class="glyphicon glyphicon-shopping-cart"></div>&nbsp;&nbsp;Ver histório de Compras</a>
                            <br/><br/>
                    ...
                    <div class="painelPremios">
                        ...
                        if ($totalPag > 0) {
                            while ($objPremio = mysql_fetch_object($pag)) {
                                ...
                                echo "<a class='btn btn-success type='button' onclick='return confirmar();' href='../../includes/functions/cadastros/resgate.php?idPremio=$objPremio->idPremio&idAmigo=$obj->idAmigo&idUsuario=$objUsuario->idUsuario'><div class='glyphicon glyphicon-star'></div>&nbsp;&nbsp;Resgatar</a>";
                                echo "</div>";
                                echo "</div>";
                            }
