...
$cmd = "select * from Resgate where status=1";
...
$cmd = "select * from Resgate where status=1 order by data DESC limit $inicio,$registros";
...
if ($total > 0) {
    ...
    for ($i = 1; $i < $numPaginas + 1; $i++) {
        echo " <li><a style='text-align:center;' href='amigoseResgates.php?pagina=$i&filter=concluidos'>" . $i . "</a></li>";
    }
    echo "</ul>";
} else {
